...
class ArtistControllerTest extends GroovyTestCase {
	...
	void testSave_invalidName(){
		def ac = new ArtistController()
		bindParamsAndSave(ac, '', '');

		assertEquals "/artist/index", ac.modelAndView.viewName
		assertNotNull ac.modelAndView.model.artistErr
		assertNull ac.modelAndView.model.artistErr.firstName
		assertNull ac.modelAndView.model.artistErr.lastName
	}
